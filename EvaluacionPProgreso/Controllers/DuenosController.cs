...
namespace EvaluacionPProgreso.Controllers
{
    public class DuenosController : Controller
    {
        ...
        public DuenosController(DanielSierraDBEvaluacionPProgreso context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Edad,AbonoCita,CorreoElectronico,EsActivo,FechaRegistro,SierraD")] Dueno dueno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Edad,AbonoCita,CorreoElectronico,EsActivo,FechaRegistro,SierraD")] Dueno dueno)
        {
            if (id != dueno.Id)
            {
                return NotFound();
